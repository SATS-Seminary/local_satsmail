...
final class external_test extends test\testcase {
    public function test_get_settings(): void {
        ...
        set_config('globaltrays', 'drafts,trash', 'local_satsmail');
        ...
        unset_config('enablebackup', 'local_satsmail');
        unset_config('maxrecipients', 'local_satsmail');
        unset_config('usersearchlimit', 'local_satsmail');
        unset_config('maxfiles', 'local_satsmail');
        unset_config('maxbytes', 'local_satsmail');
        unset_config('autosaveinterval', 'local_satsmail');
        unset_config('globaltrays', 'local_satsmail');
        unset_config('coursetrays', 'local_satsmail');
        unset_config('coursetraysname', 'local_satsmail');
        unset_config('coursebadges', 'local_satsmail');
        unset_config('coursebadgeslength', 'local_satsmail');
        unset_config('filterbycourse', 'local_satsmail');
        unset_config('incrementalsearch', 'local_satsmail');
        unset_config('incrementalsearchlimit', 'local_satsmail');
        unset_config('courselink', 'local_satsmail');
    ...
    public function test_get_preferences(): void {
        ...
        $user = $generator->create_user();
        $this->setUser($user);
        set_config('message_provider_local_satsmail_mail_enabled', 'email', 'message');
        set_user_preference('local_satsmail_mailsperpage', 20);
        set_user_preference('local_satsmail_markasread', 1);
        set_user_preference('message_provider_local_satsmail_mail_enabled', 'popup,unknown');
        ...
        unset_user_preference('local_satsmail_mailsperpage');
        unset_user_preference('local_satsmail_markasread');
        unset_user_preference('message_provider_local_satsmail_mail_enabled');
        ...
        set_user_preference('local_satsmail_mailsperpage', 4);
        ...
        set_user_preference('local_satsmail_mailsperpage', 101);
    ...
    public function test_set_preferences(): void {
        ...
        set_user_preference('local_satsmail_mailsperpage', 10);
        set_user_preference('local_satsmail_markasread', 0);
        set_user_preference('message_provider_local_satsmail_mail_enabled', 'popup,unknown');
        ...
        self::assertEquals('20', get_user_preferences('local_satsmail_mailsperpage'));
        self::assertEquals('1', get_user_preferences('local_satsmail_markasread'));
        self::assertEquals('email', get_user_preferences('message_provider_local_satsmail_mail_enabled'));
    ...
    public function test_get_message(): void {
        ...
        [$file1] = array_values($fs->get_area_files($context->id, 'local_satsmail', 'message', $message1->id, '', false));
        [$file2] = array_values($fs->get_area_files($context->id, 'local_satsmail', 'message', $message2->id, '', false));
    ...
    public function test_view_message(): void {
        ...
        self::assert_message_event('\local_satsmail\event\message_viewed', $message, $eventsink);
        ...
        self::assert_message_event('\local_satsmail\event\draft_viewed', $draft, $eventsink);
    ...
    public function test_create_message(): void {
        ...
        self::assert_message_event('\local_satsmail\event\draft_created', $draft, $eventsink);
    ...
    public function test_update_message(): void {
        ...
        self::assert_message_event('\local_satsmail\event\draft_updated', $message, $eventsink);
    ...
    public function test_send_message(): void {
        ...
        $generator->enrol_user($user4->id, $course->id);
        $generator->enrol_user($user5->id, $course->id);
        set_user_preference('local_satsmail_markasread', 1, $user3->id);
        $time = make_timestamp(2021, 10, 11, 12, 0);
        $now = time();
        $data = message_data::new($course, $user1);
        $data->to = [$user2, $user3];
        ...
        set_config('maxrecipients', '3', 'local_satsmail');
        $data = message_data::new($course, $user1);
        $data->subject = 'Subject';
