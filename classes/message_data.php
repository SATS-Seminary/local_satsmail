...
/**
 * Data of a message to be created or updated.
 *
...
class message_data {
    ...
    public static function file_options(): array {
        ...
        $configmaxbytes = get_config('local_satsmail', 'maxbytes') ?: $CFG->maxbytes;
        $configmaxfiles = get_config('local_satsmail', 'maxfiles');
