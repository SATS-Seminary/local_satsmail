 ...
 */
/*
South African Theoloigcal Seminary
 */
namespace local_satsmail;

/**
 * Search parameters for querying users of a course.
 */
class user_search {
    ...
    private function get_base_sql(string $fields): array {
        ...
        // Capability.
        $capjoin = get_with_capability_join($context, 'local/satsmail:usemail', 'u.id');
        $joins .= ' ' . $capjoin->joins;
        ...
        if (!has_capability('local/satsmail:mailsamerole', $context, $this->user->id)) {
