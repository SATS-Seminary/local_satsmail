...
/**
 * Backup support for the SATS Mail plugin.
 *
 * @package    local_satsmail
 * @copyright  2026 South African Theological Seminary
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_local_satsmail_plugin extends backup_local_plugin {
    /**
     * Returns the backup structure of the plugin data of a course.
     *
     * @return array Backup structure.
     */
    protected function define_course_plugin_structure() {
        ...
        // Messages source.
        $message->set_source_table('local_satsmail_messages', ['courseid' => backup::VAR_COURSEID], 'id');

        // Users source.
        // Roles are stored by name, for compatibility with older versions of the plugin.
        $ref->set_source_table('local_satsmail_message_refs', ['messageid' => '../../id'], 'id');
        $rolesql = 'CASE';
        foreach (\local_satsmail\message::role_names() as $role => $name) {
        ...
        // File annotations.
        $message->annotate_files('local_satsmail', 'message', 'id');
